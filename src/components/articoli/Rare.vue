...
<template>
    <div class="container">
        <!-- SMARTPHONE -->
        <div class="row article-smart  mt-4">
            <div class="col-12 d-flex justify-content-center mb-4">
                <img :src="cards[10].image" alt="">
            </div>
            <div class="col-12 my-text">
                <h3 class="text-center">{{ cards[10].title }}</h3>
                <p>{{ cards[10].text }}</p>
            </div>
            <router-link to="/" class="btn profile profile-smart">Torna alla Home</router-link>
        </div>
    </div>
    <!-- TABLET DESKTOP -->
    <div class="article-desk container">
        <div class="clearfix mt-4">
            <div>
                <img :src="cards[10].image" alt="">
            </div>
            <div class="my-text">
                <h3>{{ cards[10].title }}</h3>
                <p>{{ cards[10].text }}</p>
            </div>
        </div>
        <router-link to="/" class="btn profile">Torna alla Home</router-link>
    </div>
</template>
