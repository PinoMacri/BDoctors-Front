        ...
        .row {
            ...
            div.col-6 {
                ...
                a {
                    ...
                    &:hover {
                        text-shadow: 1px 1px 2px rgb(0, 217, 255), 0 0 1em rgb(0, 174, 255), 0 0 0.2em rgb(0, 217, 255);
                        color: white;
                    }
                }
                ...
                .selezione-hover-logo {
                    ...
                    box-shadow: 1px 1px 2px rgb(0, 217, 255), 0 0 1em rgb(0, 174, 255), 0 0 0.2em rgb(0, 217, 255);
                    position: absolute;
                    bottom: 0;
                    margin-bottom: 5px;
                }
